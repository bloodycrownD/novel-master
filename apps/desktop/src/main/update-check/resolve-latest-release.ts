/**
 * Fetches the latest GitHub release. Future: swap to list + asset filter per platform.
 */

import { githubLatestReleaseApiUrl } from "./app-meta.js";
import { parseReleaseTag } from "./parse-release-tag.js";
