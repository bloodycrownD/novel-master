...
export declare const IPC_CHANNELS: {
    readonly BOOTSTRAP_STATUS: "nm:bootstrap/status";
    readonly BOOTSTRAP_REBOOTSTRAP: "nm:bootstrap/rebootstrap";
    readonly EVENT_BUS: "nm:event-bus";
    readonly AGENT_STREAM: "nm:agent-stream";
};
...
export type BootstrapStatusResponse = BootstrapStatusReady | BootstrapStatusFailed;
